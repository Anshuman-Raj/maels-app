...
class MealsScreen extends StatelessWidget {
  const MealsScreen({super.key, this.title, required this.meals, required this.selectFavourite});
  final String? title;
  ...
  void _selectMeal(Meal meal, BuildContext context) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => RecipeScreen(meal: meal, selectFavourite: selectFavourite),
          ),
        );
      }
  @override
